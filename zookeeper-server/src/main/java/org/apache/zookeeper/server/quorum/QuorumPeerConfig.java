...
public class QuorumPeerConfig {
     ...
     * 读取 zookeeper 配置,并且转换成对象
     *
     * @param path the patch of the configuration file . 配置文件地址
     ...
     * 设置配置对象
     *
     * @param zkProp Properties to parse from. 配置文件中的数据
     * @throws IOException
     * @throws ConfigException
     */
